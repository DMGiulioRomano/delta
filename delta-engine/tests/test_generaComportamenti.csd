...
instr GeneraComportamenti
    ...
    ;
        i_which_comp+=1
        schedule "Comportamento", i_Attacco, i_Durata, gi_temp_ritmi, i_DurArm, i_Amp, i_ValOtt, i_ValReg, gi_temp_pos, i_which_comp
    od
endin
...
instr Generatore
    ...
    if i_debug == 1 then
        ...
        prints "\nresult for GenPythagFreqs:\n"
        if iRes == 1 then
            prints "Success!\n"
            ftprint gi_Intonazione
        else
            prints "just so bad...: %d\n"
        endif
    endif
endin
